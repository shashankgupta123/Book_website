  ...
  const processCommand = async (command) => {
    ...
    try {
      ...
      if (data.action === "open" && data.url) {
        ...
        navigate(data.url);
      } else if (data.action === "searchBook") {
        // Call a function from Header.jsx to trigger book search
        window.dispatchEvent(new CustomEvent("searchBookEvent", { detail: data.url.split("=")[1] }));
      }
